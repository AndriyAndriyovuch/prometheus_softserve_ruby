...
Діагональ зберігається у змінній d. Діагональ піци може бути тільки 25 або 50. Якщо діагональ не дорівнює одному з цих значень, то піца створюється із значеннями всіх змінних рівними нулю, та порожнім масивом інгредієнтів.
